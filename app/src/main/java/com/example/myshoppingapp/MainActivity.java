...
import com.example.myshoppingapp.db.ShowItemsListActivity;
import com.example.myshoppingapp.viewmodel.MainActivityViewModel;
        ...
        createButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(isForEdit) {
                    ...
                    // here we need to call viewmodel
