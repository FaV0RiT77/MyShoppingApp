...
import com.example.myshoppingapp.ItemsListAdapter;
import com.example.myshoppingapp.R;
import com.example.myshoppingapp.viewmodel.ShowItemListActivityViewModel;
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(itemName)) {
                    Toast.makeText(ShowItemsListActivity.this, "Enter Item Name",
                            Toast.LENGTH_SHORT).show();
                    return;
                }
                if(itemToUpdate == null) saveNewItem(itemName);
                else updateNewItem(itemName);
            }
        });
        initViewModel();
        initRecyclerView();
